      ...
      <div class="relative bg-white shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3">
          ...
          >
            ...
            <h3 class="text-lg font-medium text-white">Informações para contato</h3>
            ...
            <dl class="mt-8 space-y-6">
              ...
              <dd class="flex text-base text-indigo-50">
                ...
                <span class="ml-3">+55 (43) 3142-1104</span>
              </dd>
              <dt><span class="sr-only">Email</span></dt>
              <dd class="flex text-base text-indigo-50">
                <span class="mdi mdi-credit-card-plus"></span>
                <span class="ml-3">contato@vmixsolucoes.com.br</span>
              </dd>
            </dl>
            ...
            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li>
                <a href="https://www.instagram.com/vmixsolucoes" class="text-gray-400 hover:text-gray-500">
          ...
          <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
            <h3 class="text-lg font-medium text-gray-900">Fale Conosco</h3>
            <form
              action="#"
              method="POST"
