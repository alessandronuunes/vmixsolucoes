				...
				<div class="grid grid-cols-1 lg:grid-cols-3">
					...
					>
						...
						<p class="mt-6 text-base text-indigo-50 max-w-3xl">
							Fale com a nossa equipe através do formulário ao
							lado, ou se preferir pode nos ligar ou enviar um
							email
						</p>
						<dl class="mt-8 space-y-6">
							...
							<dd class="flex text-base text-indigo-50">
								...
								<span class="ml-3"
									>contato@vmixsolucoes.com.br</span
								>
							</dd>
						</dl>
						<p class="mt-6 text-base text-indigo-50 max-w-3xl">
							Nos siga atravez de nossas redes sociais
						</p>
						<ul role="list" class="mt-8 flex space-x-12">
							<li>
								<a
									href="https://www.facebook.com/vmixsolucoes"
							...
							<li>
								<a
									href="https://www.instagram.com/vmixsolucoes"
									class="text-gray-400 hover:text-gray-500"
								>
